...
plotAndGetMaxSlope<-function(i) {	
  ...
  read.table(paste("/Users/uricchio/projects/bootslabOld/anther_smut/manuscript/v2/software/simAnthSmut/simsRepGenRandHigh2/sim.",i,".txt",sep=""))->t
  scan(paste("/Users/uricchio/projects/bootslabOld/anther_smut/manuscript/v2/software/simAnthSmut/simsRepGenRandHigh2/sim.",i,".txt",sep=""),nlines=1,what=c("a"))->params
